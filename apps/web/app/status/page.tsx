  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-md w-full panel p-8 text-center animate-fadeInUp">
        ...
        <h1 className="text-2xl font-display mb-4">Acceso bloqueado</h1>
        <p className="text-muted mb-6">
          {messages[error as keyof typeof messages] || "No fue posible continuar."}
        </p>
        <Link
          href="/"
          className="inline-flex items-center justify-center rounded-xl border border-line px-4 py-2 text-text"
        >
          Volver al inicio
        </Link>
      </div>
